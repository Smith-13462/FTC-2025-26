...
import static org.firstinspires.ftc.teamcode.decode.common.DecodeConstants.FieldPosition.RED_PICKUP_LOADING_ZONE;
...
@Autonomous(name="RED FAR LAUNCH PICKUP LOADING", group="AutoRedFarLaunchZone")
//@Disabled
public class AutoOpRedFarLaunchPickupLoading extends AutoOp {
    ...
    private final DecodeConstants.FieldPosition firstPickUpPosition = RED_PICKUP_LOADING_ZONE;
    ...
    private double minWaitBeforeFirstPickup = 60, minWaitBeforeSecondPickup = 60;
